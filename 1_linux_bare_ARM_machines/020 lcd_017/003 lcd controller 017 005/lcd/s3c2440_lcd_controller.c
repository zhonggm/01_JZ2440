...
void s3c2440_lcd_controller_init(p_lcd_params plcdparams)
{
	 ...
	 *					 9M	 = 100M /[(CLKVAL+1) x 2], clkval = 4.5 , 取为5，对应vclk为8.3在[5，12]
	 *				   CLKVAL = 100/vclk/2-1
	 * [6:5]: 0b11, tft lcd
	 * [4:1]: bpp mode
	...
	*/
	...
	/* 根据LCD参数中的bpp来设置，是8bpp的话值为0xb，否则是16bpp的话值为0xc，
	   否则是24bpp的话值为0xd
	 */
	...
	/* 设置vclk, 显示模式为TFT LCD panel, bpp值*/
...
struct lcd_controller s3c2440_lcd_controller = {
	...
	.disenable = s3c2440_lcd_controller_disable,
