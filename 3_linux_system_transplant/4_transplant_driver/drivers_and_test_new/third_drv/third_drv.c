...
static struct device *thirddrv_dev;
...
/* 
ÖÐ¶ÏÊÂ¼þ·¢Éú±êÖ¾£¬ÖÐ¶Ï·þÎñ³ÌÐò½«ËüÖÃ1£¬ÔÚthird_drv_read½«ËüÇå0 ;
...
static int third_drv_init(void)  
{
	...
	thirddrv_dev = device_create(thirddrv_class, NULL, MKDEV(major, 0), NULL, "buttons");
...
{
	unregister_chrdev(major, "third_drv");//Ð¶ÔØÇý¶¯
